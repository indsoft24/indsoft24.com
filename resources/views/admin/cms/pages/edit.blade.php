                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('page_type') is-invalid @enderror" 
                                                ...
                                                <option value="general" {{ old('page_type', $page->page_type) == 'general' ? 'selected' : '' }}>General</option>
                                                <option value="service" {{ old('page_type', $page->page_type) == 'service' ? 'selected' : '' }}>Service</option>
                                                <option value="product" {{ old('page_type', $page->page_type) == 'product' ? 'selected' : '' }}>Product</option>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('state_id') is-invalid @enderror" 
                                                ...
                                                @foreach($states as $state)
                                                    <option value="{{ $state->id }}" {{ old('state_id', $page->state_id) == $state->id ? 'selected' : '' }}>
                                                        {{ $state->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="card-body">
                                        @if($page->featured_image)
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset($page->featured_image) }}" alt="Current featured image" 
