...
Route::prefix('tools')->name('tools.')->group(function () {
    ...
    Route::get('/image-compress', [ImageCompressorController::class, 'index'])->name('image-compress');
    Route::post('/image-compress/compress', [ImageCompressorController::class, 'compress'])->name('image-compress.compress');
