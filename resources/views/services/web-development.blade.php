...
@section('meta_description', 'Transparent website development pricing in India including domain, hosting, server, SSL, GST, and maintenance. IndSoft24 offers affordable web development services for startups, businesses, and enterprises.')
...
<section class="achievement-badge text-white py-5" style="margin-top:72px">
    <div class="container text-center">
        <h1 class="display-4 fw-bold mb-3">Website Development Services & Pricing in India</h1>
        <p class="lead mb-4">
            At IndSoft24, we believe in transparent pricing. No hidden costs — only clear packages and real value.
        </p>
        <a data-bs-toggle="modal" data-bs-target="#getInTouchModal" style="cursor:pointer" class="btn btn-warning btn-lg">Get a Free Quote</a>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card shadow-sm border-0 h-100 text-center p-3">
                    ...
                    <p class="text-muted">Tailor-made websites with modern UI/UX, scalable backend, and clean code quality.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm border-0 h-100 text-center p-3">
                    ...
                    <p class="text-muted">Seamless experience across desktop, tablet, and mobile for better engagement.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm border-0 h-100 text-center p-3">
                    ...
                    <p class="text-muted">Websites designed to rank better on Google with faster load speeds and SEO compliance.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="p-4 border rounded shadow-sm h-100 text-center hover-shadow">
                    ...
                    <p class="small text-muted">Your unique online identity (<code>.com</code>, <code>.in</code>, <code>.org</code>). Essential for every website.</p>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="p-4 border rounded shadow-sm h-100 text-center hover-shadow">
                    ...
                    <p class="small text-muted">Secures your website with HTTPS, builds trust, and improves Google ranking.</p>
                </div>
            </div>
        ...
        <div class="row g-4 text-center">
            <div class="col-md-3">
                <div class="p-3">
                    ...
                    <p class="text-muted">We understand your goals and gather detailed requirements for a successful project.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-3">
                    ...
                    <p class="text-muted">UI/UX design with wireframes & interactive prototypes to preview your website.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-3">
                    ...
                    <h5>Development</h5>
                    <p class="text-muted">Clean, scalable code built with PHP, Laravel, React, and modern frameworks.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-3">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="p-3 text-center border rounded shadow-sm h-100">
                    ...
                    <h5>Expert Team</h5>
                    <p class="text-muted">Our experienced developers, designers, and strategists bring your vision to life.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-3 text-center border rounded shadow-sm h-100">
...
<section class="py-5 text-center bg-light">
    <div class="container">
        ...
        <a data-bs-toggle="modal" data-bs-target="#getInTouchModal" style="cursor:pointer" class="btn btn-primary btn-lg">Request a Free Consultation</a>
    </div>
</section>
