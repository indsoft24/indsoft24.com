...
@section('content')
    ...
    @push('styles')
        <style>
            ...
            .bg-light .row > div:nth-child(2) { animation-delay: 0.15s; }
            .bg-light .row > div:nth-child(3) { animation-delay: 0.2s; }
            .bg-light .row > div:nth-child(4) { animation-delay: 0.25s; }
            .bg-light .row > div:nth-child(5) { animation-delay: 0.3s; }
            .bg-light .row > div:nth-child(6) { animation-delay: 0.35s; }
            .bg-light .row > div:nth-child(7) { animation-delay: 0.4s; }
            .bg-light .row > div:nth-child(8) { animation-delay: 0.45s; }
            .bg-light .row > div:nth-child(9) { animation-delay: 0.5s; }
            .bg-light .row > div:nth-child(10) { animation-delay: 0.55s; }
